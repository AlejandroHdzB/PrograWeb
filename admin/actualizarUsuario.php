                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="style-drop-it:hover style-dropdown dropdown-menu dropdown-menu-end" data-bs-toggle="dropdown" data-bs-display="static" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="actualizarUsuario.php">Actualizar usuarios</a></li>
            ...
            <div class="col-md-8">
                ...
                <?php
                    ...
                    if($user == '' || $nombre == '' ){
                        ...
                        $mensjaeSubTitulo = $user == '' ? "Seleccione un usuario" : "Por favor seleccione un usuario valido";
